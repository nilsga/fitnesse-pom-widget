...
//		stub(parent.getVariable(anyString())).toReturn("m2repo");
//		
//		PomWidget pomWidget = new PomWidget.Builder(parent, "").mavenProject(mavenProject).classpaths(classpaths).build();
...
//		assertEquals(pomWidget.numberOfChildren(), 2);
//	}
}
